...
public class DescriptionRecipesActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        while (cursor.moveToNext()) {
            ...
            Log.i("LOG_TAG", "ROW " + id + " HAS NAME " + name1 + "DISKR" + name2);
        ...
        ClickableSpan clickableSpan = new ClickableSpan() {
            ...
            public void onClick(View view) {
                Log.d("TAG", "CLIIIIICK");
                Intent intent = new Intent(DescriptionRecipesActivity.this, FirstaidActivity.class);
    ...
    public SpannableString parsingText(String str) {
        ...
        for(Point p : as) {
            Log.d("TAG", Integer.toString(p.x) + " | " +  Integer.toString(p.y));
            id = ids.removeFirst(); // TODO: Достали строку надо с ней что-то делать
            final String finalId = id;
            ClickableSpan clickableSpan = new ClickableSpan() {
                @Override
                public void onClick(View view) {
                    Log.d("TAG", "CLIIIIICK");
                    Intent intent = new Intent(DescriptionRecipesActivity.this, DescriptionActivity.class);
