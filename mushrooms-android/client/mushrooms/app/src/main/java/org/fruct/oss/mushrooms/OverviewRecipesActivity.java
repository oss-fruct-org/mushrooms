...
public class OverviewRecipesActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        type = getIntent().getStringExtra("typeR");
        ...
        final CatalogLoader[] catalogLoader = {new CatalogLoader(OverviewRecipesActivity.this)};
            ...
            public void onScroll(AbsListView view, int firstVisibleItem,
                ...
                if ((++firstVisibleItem + visibleItemCount > totalItemCount - 10) && (columnsCount != totalItemCount)) {
                    ...
                    if(catalogLoader[0].getStatus() != AsyncTask.Status.RUNNING ) {
                        ...
                        catalogLoader[0] = new CatalogLoader(OverviewRecipesActivity.this);
    ...
    private class SearchWatcher implements TextWatcher {
        ...
        public void onTextChanged(CharSequence c, int i, int i2, int i3) {
            ...
            //OverviewRecipesActivity.this.adapter.getFilter().filter(c);
    ...
    public void selectItem(int category){
        ...
        while (cursor.moveToNext()) {
            ...
            img = Bitmap.createScaledBitmap(img, metrics.widthPixels/4 , metrics.widthPixels/4 , true);
    ...
    private class CatalogItemClickListener implements ListView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            Intent intent = new Intent(OverviewRecipesActivity.this, DescriptionRecipesActivity.class);
